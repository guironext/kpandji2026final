...
const stats: { value: string; label: Copy }[] = [
  { value: "2024", label: { fr: "Année de fondation", en: "Year founded" } },
  { value: "100%", label: { fr: "Made in Côte d’Ivoire", en: "Made in Côte d’Ivoire" } },
  { value: "4+", label: { fr: "Modèles à venir", en: "Upcoming models" } },
  { value: "∞", label: { fr: "Vision panafricaine", en: "Pan-African vision" } },
];

const marqueeValues: Copy[] = [
  { fr: "Ingénierie locale", en: "Local engineering" },
  { fr: "Qualité d’exécution", en: "Build quality" },
  { fr: "Service de proximité", en: "Local service" },
  { fr: "Vision durable", en: "Sustainable vision" },
  { fr: "Identité africaine", en: "African identity" },
...
const pillars: { title: Copy; body: Copy; icon: React.ReactNode }[] = [
  {
    ...
    body: {
      fr: "Conception et assemblage menés par des équipes ivoiriennes, formées aux standards internationaux.",
      en: "Design and assembly carried out by Ivorian teams, trained to international standards.",
    },
    icon: (
  ...
  {
    title: { fr: "Qualité d’exécution", en: "Build quality" },
    body: {
      fr: "Contrôle qualité strict avant livraison : finitions, sécurité, fiabilité mécanique vérifiées.",
      en: "Strict quality control before delivery: finish, safety, and mechanical reliability all verified.",
    },
    icon: (
  ...
  {
    title: { fr: "Service de proximité", en: "Local service" },
    body: {
      fr: "Un réseau SAV dédié, des pièces disponibles et des conseillers à l’écoute, partout dans le pays.",
      en: "A dedicated after-sales network, available parts, and attentive advisors, all across the country.",
    },
    icon: (
      <>
  ...
  {
    title: { fr: "Vision durable", en: "Sustainable vision" },
    body: {
      fr: "Une feuille de route long terme : développer une industrie automobile africaine, exigeante et responsable.",
      en: "A long-term roadmap: building a demanding and responsible African automotive industry.",
    },
    icon: (
      <>
  ...
  {
    title: { fr: "Réseau & logistique", en: "Network & logistics" },
    body: {
      fr: "Showrooms, centres techniques et logistique pensés pour servir les réalités du terrain.",
      en: "Showrooms, technical centers, and logistics designed to meet real, on-the-ground needs.",
    },
    icon: (
      <>
  ...
  {
    title: { fr: "Identité africaine", en: "African identity" },
    body: {
      fr: "Un design et des choix techniques inspirés des routes, des usages et des aspirations du continent.",
      en: "A design and technical choices inspired by the continent's roads, uses, and aspirations.",
    },
    icon: (
      <>
        <circle cx="12" cy="12" r="9" />
...
const journey: { year: Copy; title: Copy; body: Copy }[] = [
  {
    year: { fr: "Origine", en: "Origin" },
    title: { fr: "Une conviction industrielle", en: "An industrial conviction" },
    body: {
      fr: "Faire émerger un constructeur ivoirien capable de concilier exigence technique et ancrage local.",
      en: "Building an Ivorian manufacturer capable of combining technical excellence with local roots.",
    },
  },
  {
    year: { fr: "Aujourd’hui", en: "Today" },
    title: { fr: "Conception & assemblage", en: "Design & assembly" },
    body: {
      fr: "Une gamme pensée pour les routes africaines, du SUV familial à l’utilitaire de travail.",
      en: "A range designed for African roads, from the family SUV to the work utility vehicle.",
    },
  },
  {
    year: { fr: "Demain", en: "Tomorrow" },
    title: { fr: "Une marque panafricaine", en: "A pan-African brand" },
    body: {
      fr: "Étendre le réseau, structurer le SAV et porter une signature automobile africaine reconnue.",
      en: "Expanding the network, structuring after-sales service, and carrying a recognized African automotive signature.",
    },
  },
];
...
export default function BrandPageContent() {
  ...
  return (
    <div className="min-h-screen bg-kp-bg text-kp-accent">
      {/* ───────────────────────── HERO ───────────────────────── */}
      <section
        aria-label={tr("Kpandji Automobiles — l’entreprise", "Kpandji Automobiles — the company")}
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1280px] px-5 pb-20 sm:px-8 md:pb-28 lg:px-12">
          <Reveal from="bottom">
            <div className={eyebrow}>
              ...
              {tr("L’entreprise — depuis 2024", "The company — since 2024")}
            </div>
          </Reveal>
          ...
          <Reveal from="bottom" delayMs={200}>
            <p className="mt-6 max-w-2xl font-sans text-[15px] leading-relaxed text-white/72 sm:text-[16px] md:text-[17px]">
              {tr("Constructeur et distributeur engagé derrière la marque", "A dedicated manufacturer and distributor behind the")}{" "}
              <span className="text-white">KPANDJI AUTOMOBILES</span>{" "}
              {tr(
                "— concevoir des véhicules adaptés aux réalités locales, avec une exigence de qualité et un service de proximité.",
                "brand — designing vehicles suited to local realities, with a demand for quality and a service of proximity."
              )}
            </p>
          </Reveal>
        ...
        <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 md:py-28 lg:px-12">
          <Reveal from="bottom">
            <div className="mx-auto max-w-2xl text-center">
              ...
              >
                {tr("Une vision industrielle,", "An industrial vision,")}
                <br className="hidden sm:block" /> {tr("ancrée en Afrique.", "rooted in Africa.")}
              </h2>
            </div>
          </Reveal>
              ...
              <div className="relative mx-auto w-full max-w-[440px] lg:mx-0 lg:sticky lg:top-28">
                ...
                <figure className="relative overflow-hidden rounded-2xl border border-white/10 bg-kp-elevated/40 shadow-[0_28px_90px_-42px_rgba(0,0,0,0.95)] backdrop-blur-md">
                  <div className="relative aspect-3/4 w-full bg-kp-elevated/60">
                    <Image
                      src={FOUNDER_IMAGE}
                      alt={tr("Fondateur — Kpandji Automobiles", "Founder — Kpandji Automobiles")}
                      fill
            ...
            <div className="space-y-12">
              <Reveal from="right" delayMs={80}>
                <div className="relative pl-6 sm:pl-8">
                  ...
                  />
                  <p className={eyebrow}>{tr("Origine", "Origin")}</p>
                  <h3 className="mt-3 font-serif text-2xl font-normal tracking-tight text-white md:text-3xl">
                    {tr("Bâtir un constructeur africain.", "Building an African manufacturer.")}
                  </h3>
                  <p className="mt-5 text-[15px] leading-[1.8] text-white/65 md:text-[16px]">
                    {tr(
                      "Kpandji Automobiles est née d’une conviction simple : la mobilité doit être fiable, accessible et au service du développement économique. En nous appuyant sur l’ingénierie, l’assemblage et un réseau de partenaires exigeants, nous bâtissons une offre automobile pensée pour les routes, les usages et les attentes de nos clients.",
                      "Kpandji Automobiles was born from a simple conviction: mobility must be reliable, accessible, and in service of economic development. Drawing on engineering, assembly, and a network of demanding partners, we build an automotive offering designed for our customers' roads, uses, and expectations."
                    )}
                  </p>
                </div>
              </Reveal>
              ...
              <Reveal from="right" delayMs={140}>
                <div className="relative pl-6 sm:pl-8">
                  <span
                    ...
                    className="absolute left-0 top-2 h-full w-px bg-linear-to-b from-kp-gold/60 via-kp-gold/15 to-transparent"
                  />
                  <p className={eyebrow}>{tr("Mission", "Mission")}</p>
                  <h3 className="mt-3 font-serif text-2xl font-normal tracking-tight text-white md:text-3xl">
                    {tr("Une exigence, du showroom à l’atelier.", "A standard of excellence, from the showroom to the workshop.")}
                  </h3>
                  <p className="mt-5 text-[15px] leading-[1.8] text-white/65 md:text-[16px]">
                    {tr(
                      "Proposer des véhicules robustes et modernes, accompagnés d’un service après-vente et d’équipes commerciales à l’écoute. Chaque étape — du premier essai à l’entretien — reflète notre engagement pour la transparence et la durabilité de la relation client.",
                      "Offering robust, modern vehicles, backed by after-sales service and attentive sales teams. Every step — from the first test drive to maintenance — reflects our commitment to transparency and lasting customer relationships."
                    )}
                  </p>
                </div>
              </Reveal>
                ...
                <figure className="relative overflow-hidden rounded-2xl border border-white/10 bg-linear-to-br from-kp-elevated/65 via-kp-elevated/30 to-kp-elevated/10 p-7 shadow-[0_24px_80px_-40px_rgba(0,0,0,0.9)] backdrop-blur-md md:p-10">
                  ...
                  <blockquote className="relative">
                    <p className="font-serif text-lg italic leading-[1.55] text-white/90 md:text-2xl md:leading-[1.45]">
                      {tr(
                        "Nous investissons dans l’industrie automobile ici, avec des équipes locales et une vision long terme : faire du groupe KPANDJI un repère de confiance pour les particuliers comme pour les professionnels.",
                        "We are investing in the automotive industry here, with local teams and a long-term vision: making the KPANDJI group a trusted reference for individuals and professionals alike."
                      )}
                    </p>
                    <figcaption className="mt-6 flex items-center gap-3">
                      ...
                      <span className="text-[11px] uppercase tracking-[0.24em] text-white/60">
                        {tr("Le fondateur — Kpandji Automobiles", "The founder — Kpandji Automobiles")}
                      </span>
                    </figcaption>
                  </blockquote>
                </figure>
          ...
          {[...Array(2)].map((_, dup) => (
            <div key={dup} className="flex items-center gap-12">
              {marqueeValues.map((v, i) => (
                ...
                >
                  <span className="hover:text-white">{tr(v.fr, v.en)}</span>
          ...
          <Reveal from="bottom">
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between md:gap-10">
              <div className="max-w-2xl">
                <p className={eyebrow}>
                  <span aria-hidden className="h-px w-8 bg-kp-gold/60" />
                  {tr("Nos engagements", "Our commitments")}
                </p>
                <h2
                  id="engagements-heading"
                  className="mt-4 font-serif text-[clamp(1.9rem,4vw,3rem)] font-normal leading-[1.1] tracking-tight text-white"
                >
                  {tr("Six piliers, une exigence.", "Six pillars, one standard.")}
                </h2>
              </div>
              <p className="max-w-md text-[14px] leading-relaxed text-white/55 md:text-[15px]">
                {tr(
                  "Chaque promesse devient une discipline interne — pour que la qualité ne soit jamais une option.",
                  "Every promise becomes an internal discipline — so quality is never optional."
                )}
              </p>
            </div>
          </Reveal>
              ...
              <article className="group relative h-full overflow-hidden rounded-2xl border border-white/10 bg-kp-bg p-7 transition-all duration-500 hover:-translate-y-0.5 hover:border-kp-gold/30 md:p-10">
                ...
                <div className="flex h-full flex-col">
                  ...
                  <h3 className="mt-6 font-serif text-2xl font-normal tracking-tight text-white md:text-3xl">
                    {tr(pillars[0].title.fr, pillars[0].title.en)}
                  </h3>
                  <p className="mt-4 max-w-md text-[15px] leading-relaxed text-white/70 md:text-[16px]">
                    {tr(pillars[0].body.fr, pillars[0].body.en)}
                  </p>
                  ...
                  <div className="mt-auto flex items-end justify-between pt-10">
                    <span className="inline-flex items-center gap-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-kp-gold/85">
                      <span>{tr("Pilier 01", "Pillar 01")}</span>
        ...
        <div className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 md:py-28 lg:px-12">
          <Reveal from="bottom">
            <div className="mx-auto max-w-2xl text-center">
              <p className={eyebrow + " justify-center"}>
                <span aria-hidden className="h-px w-8 bg-kp-gold/60" />
                {tr("Notre trajectoire", "Our journey")}
                <span aria-hidden className="h-px w-8 bg-kp-gold/60" />
              </p>
              <h2
                id="journey-heading"
                className="mt-5 font-serif text-[clamp(1.9rem,4vw,3rem)] font-normal leading-[1.1] tracking-tight text-white"
              >
                {tr("Hier, aujourd’hui, demain.", "Yesterday, today, tomorrow.")}
              </h2>
              <p className="mx-auto mt-5 max-w-xl text-[14px] leading-relaxed text-white/55 md:text-[15px]">
                {tr(
                  "Trois étapes pour comprendre notre démarche : d’une conviction à l’action, jusqu’à une marque pensée pour le continent.",
                  "Three steps to understand our approach: from conviction to action, all the way to a brand designed for the continent."
                )}
              </p>
            </div>
          </Reveal>
          ...
          <div className="relative mt-14 md:mt-20">
            ...
            <ol className="grid gap-10 md:grid-cols-3 md:gap-8 lg:gap-10">
              {journey.map((step, i) => (
                <Reveal key={step.year.fr} from="bottom" delayMs={i * 100}>
                  <li className="group relative flex h-full flex-col">
                    ...
                    <article className="relative flex h-full flex-col rounded-2xl border border-white/8 bg-kp-elevated/40 p-7 backdrop-blur-sm transition-all duration-500 group-hover:-translate-y-0.5 group-hover:border-kp-gold/25 group-hover:bg-kp-elevated/55 md:p-8">
                      <p className="font-serif text-2xl font-medium tracking-tight text-kp-gold/95 md:text-3xl">
                        {tr(step.year.fr, step.year.en)}
                      </p>
                      <h3 className="mt-3 font-serif text-xl font-normal text-white md:text-2xl">
                        {tr(step.title.fr, step.title.en)}
                      </h3>
                      <p className="mt-3 text-[14px] leading-relaxed text-white/60 md:text-[15px]">
                        {tr(step.body.fr, step.body.en)}
                      </p>
          ...
          <Reveal from="bottom">
            <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between md:gap-10">
              <div className="max-w-2xl">
                <p className={eyebrow}>
                  <span aria-hidden className="h-px w-8 bg-kp-gold/60" />
                  {tr("Nos installations", "Our facilities")}
                </p>
                <h2
                  id="installations-heading"
                  className="mt-4 font-serif text-[clamp(1.9rem,4vw,3rem)] font-normal leading-[1.1] tracking-tight text-white"
                >
                  {tr("Là où nos véhicules prennent vie.", "Where our vehicles come to life.")}
                </h2>
              </div>
              <p className="max-w-md text-[14px] leading-relaxed text-white/55 md:text-[15px]">
                {tr(
                  "Espaces d’accueil, atelier et suivi technique pour entretenir votre véhicule dans les règles de l’art.",
                  "Reception spaces, workshop, and technical follow-up to service your vehicle to the highest standard."
                )}
              </p>
            </div>
          </Reveal>
            ...
            <div className="mt-12 grid gap-4 md:mt-16 md:grid-cols-3 md:grid-rows-2 md:gap-5">
              ...
              <figure className="group relative overflow-hidden rounded-2xl border border-white/10 bg-kp-elevated/40 md:col-span-2 md:row-span-2">
                <div className="relative aspect-16/10 w-full md:aspect-auto md:h-full md:min-h-[480px]">
                  <Image
                    src={GARAGE_IMAGES[0]}
                    alt={tr("Atelier principal — Kpandji Automobiles", "Main workshop — Kpandji Automobiles")}
                    fill
                  ...
                  <span className="absolute left-6 top-6 inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/45 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-white/85 backdrop-blur-md">
                    ...
                    {tr("01 — Atelier", "01 — Workshop")}
                  </span>

                  <figcaption className="absolute inset-x-0 bottom-0 p-6 md:p-8">
                    <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-kp-gold/95">
                      {tr("Atelier principal", "Main workshop")}
                    </p>
                    <p className="mt-2 font-serif text-2xl font-medium text-white md:text-3xl">
                      {tr("Assemblage & contrôle qualité", "Assembly & quality control")}
                    </p>
                    <p className="mt-3 max-w-md text-[13px] leading-relaxed text-white/65 md:text-[14px]">
                      {tr(
                        "Une chaîne de production rigoureuse, où chaque véhicule est inspecté avant livraison.",
                        "A rigorous production line, where every vehicle is inspected before delivery."
                      )}
                    </p>
                  </figcaption>
                </div>
              ...
              <figure className="group relative overflow-hidden rounded-2xl border border-white/10 bg-kp-elevated/40">
                <div className="relative aspect-4/3 w-full md:aspect-auto md:h-full md:min-h-[230px]">
                  <Image
                    src={GARAGE_IMAGES[1]}
                    alt={tr("Espace d’accueil — Kpandji Automobiles", "Reception area — Kpandji Automobiles")}
                    fill
              ...
              <figure className="group relative overflow-hidden rounded-2xl border border-white/10 bg-kp-elevated/40">
                <div className="relative aspect-4/3 w-full md:aspect-auto md:h-full md:min-h-[230px]">
                  <Image
                    src={GARAGE_IMAGES[2]}
                    alt={tr("Suivi technique — Kpandji Automobiles", "Technical follow-up — Kpandji Automobiles")}
                    fill
                    sizes="(max-width: 768px) 100vw, 33vw"
                    className="object-cover transition-transform duration-1200 ease-out group-hover:scale-[1.05]"
                  />
                  ...
                  <span className="absolute left-5 top-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-black/45 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.24em] text-white/85 backdrop-blur-md">
                    <span className="size-1 rounded-full bg-kp-gold/95" />
                    {tr("03 — Service", "03 — Service")}
                  </span>
                  <figcaption className="absolute inset-x-0 bottom-0 p-5">
                    <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-kp-gold/95">
                      {tr("Service technique", "Technical service")}
                    </p>
                    <p className="mt-1.5 font-serif text-lg font-medium text-white">
                      {tr("Entretien & SAV", "Maintenance & after-sales")}
                    </p>
                  </figcaption>
                </div>
              </figure>
        ...
        <div className="mx-auto max-w-[1100px] px-5 py-24 text-center sm:px-8 md:py-36 lg:px-12">
          ...
          <Reveal from="bottom" delayMs={80}>
            <p className={eyebrow + " mt-7 justify-center"}>
              {tr("Kpandji AUTOMOBILES — Côte d’Ivoire", "Kpandji AUTOMOBILES — Côte d’Ivoire")}
            </p>
          </Reveal>
          ...
          <Reveal from="bottom" delayMs={220}>
            <p className="mx-auto mt-6 max-w-2xl text-[15px] leading-relaxed text-white/70 md:text-[16px]">
              {tr(
                "Découvrez nos véhicules, planifiez un essai ou échangez avec nos équipes — nous sommes à votre écoute.",
                "Discover our vehicles, schedule a test drive, or speak with our teams — we're here to listen."
              )}
            </p>
          </Reveal>
          ...
          <Reveal from="bottom" delayMs={380}>
            <div className="mt-14 flex flex-col items-center gap-3 text-[10px] uppercase tracking-[0.32em] text-white/35 sm:flex-row sm:justify-center sm:gap-6">
              ...
              <span>{tr("Made in Côte d’Ivoire", "Made in Côte d’Ivoire")}</span>
              <span aria-hidden className="hidden size-1 rounded-full bg-white/25 sm:block" />
              <span>{tr("Vision panafricaine", "Pan-African vision")}</span>
            </div>
          </Reveal>
        </div>
      </section>
