...
title: "Candidatures — KPANDJI Motors",
  description:
    "Envoyez votre candidature à KPANDJI Motors : parcours, compétences et CV joignez à votre message à notre équipe RH.",
  alternates: {
    canonical: "/emplois",
  },
  openGraph: {
    title: "Candidatures — KPANDJI Motors",
    description:
      "Postulez auprès de KPANDJI Motors : formulaire guidé puis envoi par e-mail avec votre CV.",
    type: "website",
    locale: "fr_FR",
  },
};
